  ...
  if (items.length === 0) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <Link to="/products" className="inline-block bg-indigo-600 text-white py-2 px-6 rounded-md hover:bg-indigo-700 transition">
          Browse Products
        </Link>
      </div>
    );
          ...
          <div className="lg:w-96">
            <div className="bg-white rounded-lg shadow p-6 sticky top-24">
              ...
              <div className="max-h-80 overflow-y-auto mb-6">
                {items.map(item => (
                  <div key={item.product.id} className="py-3 border-b border-gray-200 last:border-0">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="border-t pt-3 mt-3 border-gray-200">
                  <div className="flex justify-between font-medium">
                    ...
                    <span className="text-indigo-600 text-lg">${orderTotal.toFixed(2)}</span>
                  </div>
                </div>
              </div>
